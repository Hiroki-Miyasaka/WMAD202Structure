...
//        q5.countDuplicateNumber(new int[]{1, 6, 5, 6, 1, 6, 4, 5, 6, 5});

        Question6 q6 = new Question6();
        int[] list = { 1,2,3,4};
        ArrayList<Integer> result = q6.searchDistinctNumber(list);

        System.out.println(result); // memory address for the result variable
